...
Contact cnc::DetectCollision( Shape* a, Shape* b )
{
    Contact c;
...
void cnc::ResolveCollision( Shape* a, Shape* b, Contact c, f32 restitution, f32 friction)
{
...
Contact cnc::detect_circle_circle( Shape* a, Shape* b )
{
    Contact c;
    return c;
}

Contact cnc::detect_circle_rect( Shape* a, Shape* b )
{
    Contact c = {0};
    Circle*    circle = (Circle*)a;
...
Contact cnc::detect_circle_line( Shape* a, Shape* b )
{
    Contact c;
    return c;
}

Contact cnc::detect_rect_rect( Shape* a, Shape* b )
{
    Contact c;
    return c;
}

Contact cnc::detect_rect_line( Shape* a, Shape* b )
{
    Contact c;
    return c;
}

Contact cnc::detect_line_line( Shape* a, Shape* b )
{
    Contact c;
    return c;
}
